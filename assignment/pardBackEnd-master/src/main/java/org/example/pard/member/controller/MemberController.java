...
public class MemberController {
    ...
    @PatchMapping("/{id}")
    @Operation(summary = "맴버 아이디로 해당 맴버 patch", description = "맴버의 나이와 part, age를 바꿔주도록 한다.")
    public String patchByID(@PathVariable Long id, @RequestBody MemberCreateDTO dto){
        memberService.patchById(id, dto);
        return "patch됨";
    }
